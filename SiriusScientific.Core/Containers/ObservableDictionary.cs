...
namespace SiriusScientific.Core.Containers
{
	public sealed class ObservableDictionary<TKey, TValue> : ObservableCollection<TValue>
	{
		private readonly Dictionary<TKey, TValue> _internalDictionary;

		public delegate void OnDictionaryCollectionChanged(object sender, NotifyCollectionChangedEventArgs e);

		public event OnDictionaryCollectionChanged DictionaryCollectionChanged;
		...
		{
			DictionaryCollectionChanged?.Invoke(sender, e);
		}
		...
		{
			if (_internalDictionary.ContainsValue(item))
